  ...
  return (
    <div className="space-y-5">
      ...
      <Card className="border-l-4 border-l-st-greenDot">
        ...
        {/* Los litros y los km NO se muestran: el consumo sí, el detalle con el que se
            controla, no. Sólo queda el aviso de cuándo todavía no hay número. */}
        {!(r.closed && r.segment_kml != null) && (
          <div className="mt-1 text-sm text-ink/60">
            {r.closed ? "Es tu primer llenado, queda como base." : "Se calcula cuando llenes el tanque."}
          </div>
        )}
      </Card>
